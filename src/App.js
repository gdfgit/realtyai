    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{
            width: 80, height: 80, borderRadius: 20, background: theme.red,
            display: "inline-flex", alignItems: "center", justifyContent: "center",
            boxShadow: "0 8px 24px rgba(227,24,55,0.25)", marginBottom: 16,
          }}>
            <svg width="44" height="44" fill="none" viewBox="0 0 24 24">
              <path d="M3 12l9-9 9 9" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              <rect x="8" y="12" width="8" height="8" rx="1" stroke="white" strokeWidth="2"/>
              <circle cx="18" cy="8" r="3" fill="white" opacity="0.9"/>
              <circle cx="17" cy="7.5" r="0.5" fill={theme.red}/>
              <circle cx="19" cy="7.5" r="0.5" fill={theme.red}/>
              <path d="M17.2 9 c.3.4 1.3.4 1.6 0" stroke={theme.red} strokeWidth="0.5" strokeLinecap="round"/>
            </svg>
          </div>
      ...
      <div style={{
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{
              width: 42, height: 42, borderRadius: 12, background: theme.red,
